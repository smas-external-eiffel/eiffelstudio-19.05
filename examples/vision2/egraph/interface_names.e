...
feature -- Access
	...
	apply_new: STRING = "Make graph empty"
	
	apply_load: STRING = "Load graph"
	
	apply_save: STRING = "Save graph"
			
	add_one_node: STRING = "Add one node (Pick and drop)"
	
	add_ten_nodes: STRING = "Add ten nodes"
	
	add_hundred_nodes: STRING = "Add hundred nodes"
	
	add_thousand_nodes: STRING = "Add thousand nodes"
	
	apply_circle_layout: STRING = "Arrange nodes in a circle"
	
	apply_grid_layout: STRING = "Arrange nodes in a grid";
