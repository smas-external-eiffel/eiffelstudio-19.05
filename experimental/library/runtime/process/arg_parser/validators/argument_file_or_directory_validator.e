...
feature {NONE} -- Internationalization
	...
	e_invalid_file_or_directory_name: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified file or directory does not exist.")
		end

	e_file_or_directory_does_not_exist: IMMUTABLE_STRING_32
		once
			create Result.make_from_string_general ("The specified file or directory does not exist.")
		end
